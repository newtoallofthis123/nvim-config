return {
  ...
  cmd = 'Octo',
  keys = {
    -- Most commonly used commands (using <leader>go for GitHub Octo)
    -- Note: Most other commands are available as buffer-local mappings when viewing PRs/issues
    ...
    -- Review operations
    { '<leader>govs', '<cmd>Octo review start<cr>', desc = 'Start Review' },
    { '<leader>govr', '<cmd>Octo review resume<cr>', desc = 'Resume Review' },

    -- Search operations
    { '<leader>gops', '<cmd>Octo search<cr>', desc = 'Search GitHub' },
  },
  opts = {
    use_local_fs = false,
